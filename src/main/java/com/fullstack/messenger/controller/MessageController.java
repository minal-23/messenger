...
public class MessageController
{
    ...
    public ResponseEntity<List<ChatMessage>> getPrivateMessaages(@RequestParam String user1, @RequestParam String user2){
        List<ChatMessage>lst=chatMessageRepository.findPrivateMessagesBetweenTwoUsers(user1,user2);
